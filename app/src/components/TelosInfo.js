            ...
            <Row>
                <div className="infoContainer">
                    <Col sm={12}>
                        ...
                        <p className="pInfo2"><strong>b.</strong> cd build  </p>
                        <p className="pInfo2"><strong>c.</strong> sudo make install </p>
                        ...
                        <p className="pInfo3"><strong>i.</strong> plugin = eosio::http_plugin </p>
                        <p className="pInfo3"><strong>ii.</strong> plugin = eosio::chain_plugin </p>
                        <p className="pInfo3"><strong>iii.</strong> plugin = eosio::chain_api_plugin </p>
                        <p className="pInfo3"><strong>iv.</strong> plugin = eosio::history_plugin </p>
                        <p className="pInfo3"><strong>v.</strong> plugin = eosio::history_api_plugin </p>
                        <p className="pInfo3"><strong>vi.</strong> plugin = eosio::net_plugin </p>
                        <p className="pInfo3"><strong>vii.</strong> plugin = eosio::net_api_plugin  </p>
