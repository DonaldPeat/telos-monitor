            ...
            <Row>
                <div className="infoContainer">
                    <Col sm={12}>
                        ...
                        <p className="pInfo1"><strong>1.</strong> Follow the installation instructions <a target="_blank" href="https://github.com/Telos-Foundation/grow">here</a> to set up Grow.</p>
                        ...
                        <p className="pInfo2"><strong>a.</strong> Example: <code>grow spin single prodname1234 64.169.144.58 path/to/genesis.json stage1_1.telosfoundation.io</code></p>
                        <p className="pInfo2"><strong>b.</strong> There are also 2 optional flags: <code>--p2p-port</code> and <code>--http-port</code>. These flags have default values of <code>8888</code> and <code>9876</code>, respectively.</p>
                        ...
                        <p className="pInfo2"><strong>b.</strong> <code>git checkout Stage1.1</code></p>
